...
export function PeopleDashboard({ viewer }: { viewer: { username: string; role: "admin" | "user" } }) {
  ...
  const downloadCsv = () => {
    ...
    link.download = `techqueria-people-detailed-${new Date().toISOString().slice(0, 10)}.csv`;
